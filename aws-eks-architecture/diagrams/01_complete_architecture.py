...
===============================================
Diagrama general que muestra todos los componentes de la arquitectura

Ejecutar: python 01_complete_architecture.py
Output: output/01_ia_complete_architecture.png
"""
...
with Diagram(
    "IA Interactive - Arquitectura Completa AWS EKS",
    filename="output/01_ia_complete_architecture",
    show=False,
    direction="TB",
...
print("✅ Diagrama generado: output/01_ia_complete_architecture.png")
