"""
LibraryManager - Diagrama de Flujo SDLC
=======================================
Testing → Deployment → Maintenance → SSDLC

Ejecutar: python sdlc_flow.py
Output: output/sdlc_flow.png
"""
