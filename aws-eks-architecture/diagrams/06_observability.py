"""
IA Interactive - Observability Architecture
============================================
Diagrama del stack de monitoreo

Ejecutar: python 06_observability.py
Output: output/06_observability.png
"""
...
with Diagram(
    ...
    filename="output/06_observability",
    show=False,
    direction="TB",
...
print("✅ Diagrama generado: output/06_observability.png")
