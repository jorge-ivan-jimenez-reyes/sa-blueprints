"""
IA Interactive - Front Office Architecture
==========================================
Diagrama del sitio público (Landing Page)

Ejecutar: python 02_front_office.py
Output: output/02_front_office.png
"""
...
with Diagram(
    ...
    filename="output/02_front_office",
    show=False,
    direction="LR",
...
print("✅ Diagrama generado: output/02_front_office.png")
