"""
IA Interactive - CI/CD Pipeline Architecture
=============================================
Diagrama del pipeline de integración y despliegue

Ejecutar: python 07_cicd.py
Output: output/07_cicd.png
"""
...
print("✅ Diagrama generado: output/07_cicd.png")
