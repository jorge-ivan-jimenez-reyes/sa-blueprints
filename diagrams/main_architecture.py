"""
IA Interactive - Arquitectura de Solución para Sitio Web Corporativo
=====================================================================
Diagrama de arquitectura usando la librería Diagrams (Python)

Ejecutar: python main_architecture.py
Output: output/ia_interactive_architecture.png
"""
...
with Diagram(
    ...
    filename="output/ia_interactive_architecture",
    show=False,
    direction="TB",
...
print("✅ Diagrama generado: output/ia_interactive_architecture.png")
