...
===================================
Muestra las capas de protección de la arquitectura

Ejecutar: python security_layers.py
Output: output/ia_interactive_security.png
"""
...
with Diagram(
    "IA Interactive - Capas de Seguridad",
    filename="output/ia_interactive_security",
    show=False,
    direction="TB",
...
print("✅ Diagrama generado: output/ia_interactive_security.png")
